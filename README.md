...
- 菜单栏可复制显示环境诊断，记录当前屏幕组合、休息页窗口、设置窗口和窗口层级。
...
- 显示环境诊断：可复制当前屏幕组合、休息页窗口、设置窗口、窗口层级和轻打扰状态，方便反馈外接屏、投屏或合盖后的现场。
...
- 睡眠/锁屏实机压测：已加入恢复、午休、睡眠隐藏、长离开、显示、显示边界、显示环境诊断、真实显示环境和窗口让开压测入口；后续继续覆盖更多外接屏真实组合，结合恢复诊断继续收敛边界问题。
