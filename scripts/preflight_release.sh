...
check_contains "$SOURCE_CONTENT" "NSMakeRect(14, 341 - index * 36, 204, 31)" "settings compact sidebar row guard"
...
check_contains "$SOURCE_CONTENT" "NSMakeRect(2, 382, 38, 38)" "settings compact page icon guard"
...
check_contains "$SOURCE_CONTENT" "NSMakeRect(54, 384, 28, 2)" "settings quiet page accent guard"
check_contains "$SOURCE_CONTENT" "card.layer.shadowOpacity = 0.014" "settings initial card shadow guard"
