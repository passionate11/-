...
check_contains "$SOURCE_CONTENT" "ERColor(0.972, 0.974, 0.979, 1)" "settings soft content background guard"
...
check_contains "$SOURCE_CONTENT" "NSMakeRect(26, 520, 38, 38)" "settings compact brand badge guard"
check_contains "$SOURCE_CONTENT" "NSMakeRect(24, 432, 184, 64)" "settings soft summary card guard"
check_contains "$SOURCE_CONTENT" "NSMakeRect(6, 172 - index * 34, 196, 30)" "settings compact sidebar row guard"
...
check_contains "$SOURCE_CONTENT" "NSMakeRect(2, 400, 38, 38)" "settings compact page icon guard"
...
check_contains "$SOURCE_CONTENT" "NSMakeRect(54, 402, 28, 2)" "settings quiet page accent guard"
check_contains "$SOURCE_CONTENT" "card.layer.shadowOpacity = 0.004" "settings initial card shadow guard"
