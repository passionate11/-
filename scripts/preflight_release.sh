...
check_contains "$SOURCE_CONTENT" "ERColor(0.964, 0.967, 0.974, 1)" "settings soft content background guard"
...
check_contains "$SOURCE_CONTENT" "NSMakeRect(24, 512, 44, 44)" "settings compact brand badge guard"
check_contains "$SOURCE_CONTENT" "NSMakeRect(22, 422, 188, 74)" "settings soft summary card guard"
check_contains "$SOURCE_CONTENT" "NSMakeRect(18, 341 - index * 36, 196, 31)" "settings compact sidebar row guard"
check_contains "$SOURCE_CONTENT" "configurationWithPointSize:13" "settings compact sidebar icon guard"
...
check_contains "$SOURCE_CONTENT" "card.layer.shadowOpacity = 0.010" "settings initial card shadow guard"
