...
check_token "soft content background" "ERColor(0.968, 0.971, 0.976, 1)"
check_token "content width" "NSMakeRect(252, 74, 664, 456)"
check_token "wide card" "NSMakeRect(0, 0, 664, 340)"
...
check_token "compact brand badge" "NSMakeRect(28, 522, 34, 34)"
check_token "brand subtitle" "护眼 · 站立 · 专注"
check_token "summary card" "sidebarSummaryCard"
check_token "soft summary card" "NSMakeRect(24, 440, 184, 54)"
check_token "summary accent" "sidebarSummaryAccentView"
check_token "sidebar nav group" "sidebarNavGroupView"
check_token "grouped nav shell" "NSMakeRect(12, 194, 208, 194)"
...
check_token "transparent reliable hit area" "button.alphaValue = 1.0"
check_token "no button highlight" "setHighlightsBy:NSNoCellMask"
check_token "selected indicator" "sidebarNavIndicatorViews"
check_token "compact nav row" "NSMakeRect(6, 160 - index * 32, 196, 28)"
check_token "icon badge layer" "sidebarNavIconBadgeViews"
check_token "compact nav icon" "configurationWithPointSize:12"
...
check_token "compact page icon badge" "NSMakeRect(6, 408, 32, 32)"
check_token "page accent" "pageAccentViews"
check_token "quiet page accent" "NSMakeRect(50, 412, 24, 2)"
check_token "overview wide status band" "NSMakeRect(24, 262, 616, 54)"
check_token "overview status pill" "NSMakeRect(496, 15, 104, 24)"
check_token "overview dual timer width" "NSMakeRect(24, 146, 296, 96)"
check_token "overview icon wells" "NSMakeRect(14, 52, 24, 24)"
check_token "overview insight band" "overviewInsightBand"
check_token "overview accent layer" "overviewAccentViews"
check_token "overview soft accent layer" "overviewSoftAccentViews"
check_token "overview action bar" "NSMakeRect(24, 28, 616, 34)"
...
check_token "low action bar opacity" "[theme.cardBorder colorWithAlphaComponent:0.014]"
check_token "toolbar action shells" "shell.layer.borderWidth = settingsDarkStyle ? 0.5 : 0"
check_token "initial card shadow reduced" "card.layer.shadowOpacity = 0.002"
check_token "reduced card shadow" "card.layer.shadowRadius = settingsDarkStyle ? 9 : 4"
check_token "reduced card motif" "settings-card-motif\", 0.022"
check_token "small time input controls" "field.controlSize = NSControlSizeSmall"
check_token "centered time input typography" "field.font = [NSFont monospacedDigitSystemFontOfSize:13.5 weight:NSFontWeightRegular]"
check_token "time unit labels themed" "timeUnitLabels"
check_token "soft accent theming" "accent.layer.backgroundColor = [settingsAccentColor colorWithAlphaComponent:settingsDarkStyle ? 0.16 : 0.095]"
check_token "dark contrast guard" "settingsDarkStyle = self.settings.restStyle == ERRestStyleNight"
check_token "settings accent contrast" "ERSettingsAccentColor"
check_token "theme-aware preview" "stylePreviewMotif"
check_token "theme-aware page icons" "icon.contentTintColor = settingsAccentColor"
