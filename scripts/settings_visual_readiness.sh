...
check_token "wide card" "NSMakeRect(0, 0, 664, 324)"
...
check_token "compact nav row" "NSMakeRect(18, 341 - index * 36, 196, 31)"
...
check_token "low action bar opacity" "[theme.cardBorder colorWithAlphaComponent:0.032]"
check_token "toolbar action shells" "shell.layer.borderWidth = settingsDarkStyle ? 0.5 : 0"
check_token "initial card shadow reduced" "card.layer.shadowOpacity = 0.010"
check_token "reduced card shadow" "card.layer.shadowRadius = settingsDarkStyle ? 12 : 7"
