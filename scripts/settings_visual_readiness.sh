...
check_token "content background" "ERColor(0.965, 0.972, 0.982, 1)"
...
check_token "accent selected pill" "[theme.accent colorWithAlphaComponent:0.12]"
check_token "soft selected border" "0.16]"
...
check_token "white grouped rows" "[NSColor colorWithWhite:1 alpha:0.30]"
check_token "low action bar opacity" "[theme.cardBorder colorWithAlphaComponent:0.072]"
check_token "wide card shadow" "card.layer.shadowRadius = settingsDarkStyle ? 20 : 18"
check_token "reduced card motif" "settings-card-motif\", 0.055"
