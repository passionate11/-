...
check_token "content background" "ERColor(0.952, 0.958, 0.968, 1)"
...
check_token "native selected row" "[NSColor selectedContentBackgroundColor]"
check_token "selected text contrast" "NSColor.alternateSelectedControlTextColor"
...
check_token "reduced card shadow" "card.layer.shadowRadius = settingsDarkStyle ? 16 : 12"
