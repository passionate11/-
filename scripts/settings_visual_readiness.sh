...
check_token "content background" "ERColor(0.955, 0.965, 0.985, 1)"
...
check_token "selected color from theme" "[theme.card colorWithAlphaComponent:0.66]"
check_token "soft selected border" "0.18]"
...
check_token "low row opacity" "[theme.cardBorder colorWithAlphaComponent:0.075]"
check_token "low action bar opacity" "[theme.cardBorder colorWithAlphaComponent:0.095]"
