...
check_token "soft content background" "ERColor(0.972, 0.974, 0.979, 1)"
check_token "content width" "NSMakeRect(252, 78, 664, 448)"
check_token "wide card" "NSMakeRect(0, 0, 664, 332)"
...
check_token "compact nav row" "NSMakeRect(6, 172 - index * 34, 196, 30)"
...
check_token "compact page icon badge" "NSMakeRect(2, 400, 38, 38)"
check_token "page accent" "pageAccentViews"
check_token "quiet page accent" "NSMakeRect(54, 402, 28, 2)"
check_token "overview wide status band" "NSMakeRect(20, 248, 624, 56)"
check_token "overview dual timer width" "NSMakeRect(20, 136, 302, 94)"
check_token "overview insight band" "overviewInsightBand"
check_token "overview accent layer" "overviewAccentViews"
check_token "overview action bar" "NSMakeRect(20, 20, 624, 34)"
...
check_token "low action bar opacity" "[theme.cardBorder colorWithAlphaComponent:0.022]"
check_token "toolbar action shells" "shell.layer.borderWidth = settingsDarkStyle ? 0.5 : 0"
check_token "initial card shadow reduced" "card.layer.shadowOpacity = 0.004"
check_token "reduced card shadow" "card.layer.shadowRadius = settingsDarkStyle ? 10 : 5"
