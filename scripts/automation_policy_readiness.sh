...
check_token "app notify label" "应用只通知"
check_token "app pause label" "应用自动暂停"
check_token "app ignore label" "应用不处理"
check_token "calendar notify label" "日程只通知"
check_token "calendar pause label" "日程自动暂停"
...
check_token "changelog entry" "自动化策略就绪检查" "$CHANGELOG_FILE"
