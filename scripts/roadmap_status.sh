...
check_evidence "automation keyword config readiness" "automation keyword config assessed" "$ROOT_DIR/scripts/automation_keyword_config_readiness.sh"
print_kv "Status" "implemented-with-diagnostics"

print_section "v0.1.49 Settings Visual Polish"
...
check_evidence "soft content background" "ERColor(0.968, 0.971, 0.976, 1)"
check_evidence "compact sidebar controls" "NSMakeRect(6, 160 - index * 32, 196, 28)"
check_evidence "quiet page header" "NSMakeRect(50, 412, 24, 2)"
check_evidence "wide quiet card" "NSMakeRect(0, 0, 664, 340)"
check_evidence "initial card shadow" "card.layer.shadowOpacity = 0.002"
...
check_evidence "overview soft accent views" "overviewSoftAccentViews"
check_evidence "overview status pill" "NSMakeRect(496, 15, 104, 24)"
...
check_evidence "release evidence json manifest" "manifest.json" "$ROOT_DIR/scripts/capture_release_evidence.sh"
check_evidence "release evidence checklist" "evidence-checklist.md" "$ROOT_DIR/scripts/capture_release_evidence.sh"
check_evidence "release evidence sha manifest" "archiveSha256" "$ROOT_DIR/scripts/capture_release_evidence.sh"
...
check_evidence "automation keyword config script" "automation_keyword_config_readiness.sh" "$ROOT_DIR/scripts/automation_keyword_config_readiness.sh"
