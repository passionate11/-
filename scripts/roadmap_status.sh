...
check_evidence "soft content background" "ERColor(0.964, 0.967, 0.974, 1)"
check_evidence "compact sidebar controls" "NSMakeRect(14, 341 - index * 36, 204, 31)"
check_evidence "quiet page header" "NSMakeRect(54, 384, 28, 2)"
check_evidence "initial card shadow" "card.layer.shadowOpacity = 0.014"
